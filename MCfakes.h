...
// Fri Sep 17 22:20:19 2021 by ROOT version 6.14/02
// from TTree fitter_tree/reduced tree for T&P
// found on file: FormattedLowPt_Fakes_March21_NoRegr_BuToKJpsi_ToMuMu.root
//////////////////////////////////////////////////////////
...
#ifdef MCfakes_cxx
MCfakes::MCfakes(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("FormattedLowPt_Fakes_March21_NoRegr_BuToKJpsi_ToMuMu.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("FormattedLowPt_Fakes_March21_NoRegr_BuToKJpsi_ToMuMu.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("FormattedLowPt_Fakes_March21_NoRegr_BuToKJpsi_ToMuMu.root:/tnpAna");
...
Int_t MCfakes::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCfakes::LoadTree(Long64_t entry)
{
...
void MCfakes::Show(Long64_t entry)
{
...
Int_t MCfakes::Cut(Long64_t entry)
{
